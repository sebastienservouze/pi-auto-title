...
test("normalizeSessionTitle strips quotes, prefix, and trailing punctuation", () => {
...
test("normalizeSessionTitle handles English model output", () => {
...
test("pickCheapestAvailableModel sorts by output cost then input cost", () => {
  const models = [
